...
class CartController extends Controller
{
    ...
    public function index()
    {
        ...
        return new CartResource(true, 'List of Carts : ' .
    ...
    public function store(Request $request)
    {
        ...
        return new CartResource(true, 'Cart has been added', $item);
    }
    ...
    public function getCartPrice()
    {
        ...
        return new CartResource(true, 'Total Price : ' . $totalPrice, $totalPrice);
    }
    ...
    public function cartWeight()
    {
        ...
        return new CartResource(true, 'Total Weight : ' . $totalWeight, $totalWeight);
    }

    public function removeCart(Request $request)
    {
        $cart = Cart::with('product')
            ->whereId($request->cart_id)->first();

        $cart->delete();

        return new CartResource(true, 'Cart has been removed', $cart);
    }
